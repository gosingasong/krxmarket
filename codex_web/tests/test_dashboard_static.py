...
class DashboardStaticTests(unittest.TestCase):
    ...
    def test_daily_memo_rolls_to_next_day_and_clear_buttons_exist(self):
        ...
        self.assertIn("const pendingState = normalizeMemoState(memoState)", app)
        self.assertIn("memoState = pendingState", app)
        ...
        self.assertIn('app.js?v=20260727-memo-auth-fix', html)
