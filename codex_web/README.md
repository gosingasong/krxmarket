...
웹 화면의 메모장은 서버에 저장하지 않고 브라우저 `localStorage`에 날짜별로 저장합니다. 같은 브라우저/기기에서는 유지되지만, 다른 PC나 휴대폰으로 자동 동기화되지는 않습니다.

## 배포 메모

- GitHub Actions 스케줄은 평일 20:40 KST로 잡혀 있습니다.
